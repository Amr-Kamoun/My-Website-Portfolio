...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Interactive dashboard displaying weather data with charts and predictions.',
    ...
    },
    {
      ...
      description: 'Analytics dashboard for social media management with scheduling features.',
